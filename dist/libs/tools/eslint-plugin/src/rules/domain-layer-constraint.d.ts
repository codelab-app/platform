...
export declare const domainLayerConstraint: ESLintUtils.RuleModule<"endpointGraphqlConstraint" | "fragmentGraphqlConstraint" | "graphqlExtension" | "noCodegenImport", never[], ESLintUtils.RuleListener>;
