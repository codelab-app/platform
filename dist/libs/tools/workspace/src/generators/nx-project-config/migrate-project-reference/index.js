...
const update_package_dependencies_1 = require("./update-package-dependencies");
const update_project_tsconfig_1 = require("./update-project-tsconfig");
// Re-export the functions
var create_nonbuildable_package_json_2 = require("./create-nonbuildable-package-json");
...
var update_package_dependencies_2 = require("./update-package-dependencies");
