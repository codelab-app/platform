...
exports.migrateProjectReference = exports.updateAppDependencies = exports.getProjectDependencies = exports.updateProjectTsconfig = exports.createNonbuildableProjectPackageJson = void 0;
...
Object.defineProperty(exports, "updateAppDependencies", { enumerable: true, get: function () { return update_app_dependencies_2.updateAppDependencies; } });
/**
...
const migrateProjectReference = async (tree, projectConfig) => {
    ...
    (0, update_app_dependencies_1.updateAppDependencies)(tree, projectConfig);
