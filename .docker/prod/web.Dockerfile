...
# Set AUTH0 variables with defaults for build time
# These will be overridden at runtime with real values from CircleCI context
ENV AUTH0_SECRET=${AUTH0_SECRET:-dummy_secret_for_build}
ENV AUTH0_DOMAIN=${AUTH0_DOMAIN:-dummy.auth0.com}
ENV AUTH0_CLIENT_ID=${AUTH0_CLIENT_ID:-dummy_client_id}
ENV AUTH0_CLIENT_SECRET=${AUTH0_CLIENT_SECRET:-dummy_client_secret}
