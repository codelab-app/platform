...
/**
 * @deprecated for now until we can remove the useStore dependency
 */
  ...
  ({ children, ...restProps }: RenderedComponentProps & ResponsiveProps) => {
    ...
    const rglChildren = useMemo(() => {
      return React.Children.map(children, (child) => {
        // if not react element, then it's an primitive value, and we don't have anything identify it
        // TODO: handle primitive situation if necessary
