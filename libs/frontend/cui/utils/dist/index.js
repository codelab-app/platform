function D(e) {
  ...
  if (typeof e == "string" || typeof e == "number") o += e;
    ...
    var l = e.length;
    for (r = 0; r < l; r++) e[r] && (t = D(e[r])) && (o && (o += " "), o += t);
  } else for (t in e) e[t] && (o && (o += " "), o += t);
  return o;
}
function se() {
  for (var e, r, t = 0, o = "", l = arguments.length; t < l; t++) (e = arguments[t]) && (r = D(e)) && (o && (o += " "), o += r);
  return o;
}
const $ = "-";
function ie(e) {
...
function ee(e, r) {
  ...
  const t = e[0], o = r.nextPart.get(t), l = o ? ee(e.slice(1), o) : void 0;
  if (l)
    return l;
...
function pe(e) {
  ...
  } = e, o = r.length === 1, l = r[0], n = r.length;
  function s(a) {
    const u = [];
    let f = 0, p = 0, g;
    ...
    const h = u.length === 0 ? a : a.substring(p), x = h.startsWith(re), S = x ? h.substring(1) : h, y = g && g > p ? g - p : void 0;
    return {
      modifiers: u,
...
function me(e, r) {
  ...
  return e.trim().split(ge).map((s) => {
    ...
    let g = !!p, h = o(g ? f.substring(0, p) : f);
    if (!h) {
      if (!g)
        return {
          isTailwindClass: !1,
    ...
    return n.has(p) ? !1 : (n.add(p), l(u, f).forEach((g) => n.add(a + g)), !0);
...
function ye(e, ...r) {
  ...
  function s(u) {
    ...
    return t = fe(f), o = t.cache.get, l = t.cache.set, n = a, a(u);
  }
  function a(u) {
    const f = o(u);
    if (f)
...
const We = /* @__PURE__ */ ye(Le), Ve = (...e) => We(se(e));
export {
  Ve as cn
};
