...
export type TagFragment = { id: string, name: string, children: Array<{ id: string, name: string }>, descendants: Array<{ id: string, name: string }>, owner: OwnerFragment, parent?: { id: string } | null };
