 ...
 */
export type LayoutProps<Params extends keyof UrlParams = never> = ParamProps<Params> & {
    children: ReactNode;
};
/**
...
export type DashboardLayoutProps<SlotKey extends keyof DashboardSlots = never, ParamKey extends keyof UrlParams = never> = ParamProps<ParamKey> & SlotProps<SlotKey> & {
    children: ReactNode;
};
/**
