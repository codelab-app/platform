 ...
 */
export type SearchParamsClientProps = Assign<TreeViewClientProps, PaginationClientProps>;
export type SearchParamsProps<Key extends keyof SearchParamsClientProps = never> = [Key] extends [never] ? {
    searchParams?: undefined;
} : {
    searchParams: Promise<{
        [K in Key]: SearchParamsClientProps[K];
    }>;
};
/**
