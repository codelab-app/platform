...
export declare enum UiKey {
    ...
    ElementPopconfirmFormDelete = "ElementPopconfirmFormDelete",
    ElementPopconfirmOverlayDelete = "ElementPopconfirmOverlayDelete",
    ...
    RedirectPopconfirmDelete = "RedirectPopconfirmDelete",
