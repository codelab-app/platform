...
export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../../../node_modules/.vite/libs/frontend/domain/element',
  plugins: [
    react(),
    dts({
      entryRoot: 'src',
  ...
  build: {
    ...
    lib: {
      ...
      entry: {
        ...
        'use-cases/element-options': 'src/use-cases/element-options/index.ts',
        'use-cases/incremented-name': 'src/use-cases/incremented-name/index.ts',
      },
      name: '@codelab/frontend-domain-element',
