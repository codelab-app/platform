...
import { ArrayTypeWithItemTypeFragment, ArrayTypeFragment } from './fragments/ArrayType.fragment.v2.graphql.gen';
...
import { ArrayTypeWithItemTypeFragmentDoc, ArrayTypeFragmentDoc } from './fragments/ArrayType.fragment.v2.graphql.gen';
...
export type GetInterfaceTypesWithFieldsQuery = { types: Array<InterfaceTypeWithFieldsFragment> };
...
export type GetInterfaceTypeGraphsQuery = { types: Array<InterfaceTypeWithGraphFragment> };
...
export const GetInterfaceTypesWithFieldsGql = gql`
    query GetInterfaceTypesWithFields($options: InterfaceTypeOptions, $where: InterfaceTypeWhere) {
  types: interfaceTypes(where: $where, options: $options) {
...
export const GetInterfaceTypeGraphsGql = gql`
    query GetInterfaceTypeGraphs($options: InterfaceTypeOptions, $where: InterfaceTypeWhere) {
  types: interfaceTypes(where: $where, options: $options) {
...
export const GetMonacoTypesGql = gql`
  ...
  const injectedRtkApi = api.injectEndpoints({
    endpoints: (build) => ({
      GetPrimitiveTypes: build.query<GetPrimitiveTypesQuery, GraphqlOperationOptions<GetPrimitiveTypesQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetPrimitiveTypesGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetArrayTypes: build.query<GetArrayTypesQuery, GraphqlOperationOptions<GetArrayTypesQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetArrayTypesGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetUnionTypes: build.query<GetUnionTypesQuery, GraphqlOperationOptions<GetUnionTypesQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetUnionTypesGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetInterfaceTypes: build.query<GetInterfaceTypesQuery, GraphqlOperationOptions<GetInterfaceTypesQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetInterfaceTypesGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetInterfaceTypesWithFields: build.query<GetInterfaceTypesWithFieldsQuery, GraphqlOperationOptions<GetInterfaceTypesWithFieldsQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetInterfaceTypesWithFieldsGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetInterfaceTypeGraphs: build.query<GetInterfaceTypeGraphsQuery, GraphqlOperationOptions<GetInterfaceTypeGraphsQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetInterfaceTypeGraphsGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetElementTypes: build.query<GetElementTypesQuery, GraphqlOperationOptions<GetElementTypesQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetElementTypesGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetRenderPropsTypes: build.query<GetRenderPropsTypesQuery, GraphqlOperationOptions<GetRenderPropsTypesQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetRenderPropsTypesGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetEnumTypes: build.query<GetEnumTypesQuery, GraphqlOperationOptions<GetEnumTypesQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetEnumTypesGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetLambdaTypes: build.query<GetLambdaTypesQuery, GraphqlOperationOptions<GetLambdaTypesQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetLambdaTypesGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetPageTypes: build.query<GetPageTypesQuery, GraphqlOperationOptions<GetPageTypesQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetPageTypesGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetAppTypes: build.query<GetAppTypesQuery, GraphqlOperationOptions<GetAppTypesQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetAppTypesGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
      GetMonacoTypes: build.query<GetMonacoTypesQuery, GraphqlOperationOptions<GetMonacoTypesQueryVariables> | void | undefined>({
        query: (options) => ({ document: GetMonacoTypesGql, options: {...{"context":{"env":"v2"}}, ...options}, })
      }),
    }),
  });
  export { injectedRtkApi as api };
  export const { useGetPrimitiveTypesQuery, useLazyGetPrimitiveTypesQuery, useGetArrayTypesQuery, useLazyGetArrayTypesQuery, useGetUnionTypesQuery, useLazyGetUnionTypesQuery, useGetInterfaceTypesQuery, useLazyGetInterfaceTypesQuery, useGetInterfaceTypesWithFieldsQuery, useLazyGetInterfaceTypesWithFieldsQuery, useGetInterfaceTypeGraphsQuery, useLazyGetInterfaceTypeGraphsQuery, useGetElementTypesQuery, useLazyGetElementTypesQuery, useGetRenderPropsTypesQuery, useLazyGetRenderPropsTypesQuery, useGetEnumTypesQuery, useLazyGetEnumTypesQuery, useGetLambdaTypesQuery, useLazyGetLambdaTypesQuery, useGetPageTypesQuery, useLazyGetPageTypesQuery, useGetAppTypesQuery, useLazyGetAppTypesQuery, useGetMonacoTypesQuery, useLazyGetMonacoTypesQuery } = injectedRtkApi;
