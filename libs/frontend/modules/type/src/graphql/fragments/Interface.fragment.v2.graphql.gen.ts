...
export type InterfaceTypeFieldEdgeFragment = { key: string, description?: string | null | undefined, cursor: string, name?: string | null | undefined, node: (
...
export type InterfaceTypeWithFieldsFragment = (
  { fieldsConnection: { totalCount: number, edges: Array<InterfaceTypeFieldEdgeFragment> } }
