...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetAppProduction(variables: GetAppProductionQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetAppProductionQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAppProductionQuery>(GetAppProductionDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetAppProduction', 'query', variables);
    }
  };
}
