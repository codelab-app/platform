...
export type GetAppDevelopmentQuery = { actionTypes: Array<ActionTypeFragment>, apps: Array<AppDevelopmentFragment>, atoms: Array<AtomDevelopmentFragment>, authGuards: Array<AuthGuardFragment>, codeMirrorTypes: Array<CodeMirrorTypeFragment>, components: Array<ComponentDevelopmentFragment>, primitiveTypes: Array<PrimitiveTypeFragment>, reactNodeTypes: Array<ReactNodeTypeFragment>, redirects: Array<RedirectFragment>, renderPropTypes: Array<RenderPropTypeFragment>, resources: Array<ResourceFragment>, richTextTypes: Array<RichTextTypeFragment> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetAppDevelopment(variables: GetAppDevelopmentQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetAppDevelopmentQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAppDevelopmentQuery>(GetAppDevelopmentDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetAppDevelopment', 'query', variables);
    }
  };
}
