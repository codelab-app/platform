...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreateTags(variables: CreateTagsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateTagsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateTagsMutation>(CreateTagsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateTags', 'mutation', variables);
    },
    UpdateTags(variables: UpdateTagsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdateTagsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateTagsMutation>(UpdateTagsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateTags', 'mutation', variables);
    },
    DeleteTags(variables: DeleteTagsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteTagsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteTagsMutation>(DeleteTagsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteTags', 'mutation', variables);
    },
