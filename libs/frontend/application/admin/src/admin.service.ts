  ...
  implements IAdminService
{
  ...
  exportData = _async(function* (this: AdminService, data: ExportDto) {
    return yield* _await(restPlatformApiClient.post('/admin/export', data))
  })
  ...
  importData = _async(function* (this: AdminService, data: ImportDto) {
    return yield* _await(restPlatformApiClient.post('/admin/import', data))
  })

  @modelFlow
  @transaction
  resetDatabase = _async(function* (this: AdminService) {
    return yield* _await(restPlatformApiClient.post('/admin/reset-database'))
  })
  ...
  resetDatabaseExceptUser = _async(function* (this: AdminService) {
    return yield* _await(
      restPlatformApiClient.post('/admin/reset-database-except-user'),
    )
  })
