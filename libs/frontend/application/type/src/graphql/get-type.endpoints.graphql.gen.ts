...
export type GetBaseTypesQuery = { baseTypes: { totalCount: number, items: Array<BaseType_ActionType_Fragment | BaseType_AppType_Fragment | BaseType_ArrayType_Fragment | BaseType_CodeMirrorType_Fragment | BaseType_ElementType_Fragment | BaseType_EnumType_Fragment | BaseType_InterfaceType_Fragment | BaseType_LambdaType_Fragment | BaseType_PageType_Fragment | BaseType_PrimitiveType_Fragment | BaseType_ReactNodeType_Fragment | BaseType_RenderPropType_Fragment | BaseType_RichTextType_Fragment | BaseType_UnionType_Fragment> } };
...
export type GetTypeOptionsQuery = { baseTypes: { items: Array<{ id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string } | { id: string, kind: Types.TypeKind, name: string }> } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetBaseTypes(variables?: GetBaseTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetBaseTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetBaseTypesQuery>(GetBaseTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetBaseTypes', 'query', variables);
    },
    GetTypes(variables?: GetTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetTypesQuery>(GetTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetTypes', 'query', variables);
    },
    GetDescendants(variables?: GetDescendantsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetDescendantsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDescendantsQuery>(GetDescendantsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetDescendants', 'query', variables);
    },
    GetPrimitiveTypes(variables?: GetPrimitiveTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPrimitiveTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPrimitiveTypesQuery>(GetPrimitiveTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPrimitiveTypes', 'query', variables);
    },
    GetArrayTypes(variables?: GetArrayTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetArrayTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetArrayTypesQuery>(GetArrayTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetArrayTypes', 'query', variables);
    },
    GetUnionTypes(variables?: GetUnionTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetUnionTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUnionTypesQuery>(GetUnionTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetUnionTypes', 'query', variables);
    },
    GetInterfaceTypes(variables?: GetInterfaceTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetInterfaceTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetInterfaceTypesQuery>(GetInterfaceTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetInterfaceTypes', 'query', variables);
    },
    GetElementTypes(variables?: GetElementTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetElementTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetElementTypesQuery>(GetElementTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetElementTypes', 'query', variables);
    },
    GetRenderPropTypes(variables?: GetRenderPropTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetRenderPropTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRenderPropTypesQuery>(GetRenderPropTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetRenderPropTypes', 'query', variables);
    },
    GetReactNodeTypes(variables?: GetReactNodeTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetReactNodeTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetReactNodeTypesQuery>(GetReactNodeTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetReactNodeTypes', 'query', variables);
    },
    GetRichTextTypes(variables?: GetRichTextTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetRichTextTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRichTextTypesQuery>(GetRichTextTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetRichTextTypes', 'query', variables);
    },
    GetEnumTypes(variables?: GetEnumTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetEnumTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetEnumTypesQuery>(GetEnumTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetEnumTypes', 'query', variables);
    },
    GetLambdaTypes(variables?: GetLambdaTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetLambdaTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetLambdaTypesQuery>(GetLambdaTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetLambdaTypes', 'query', variables);
    },
    GetPageTypes(variables?: GetPageTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPageTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPageTypesQuery>(GetPageTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPageTypes', 'query', variables);
    },
    GetAppTypes(variables?: GetAppTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetAppTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAppTypesQuery>(GetAppTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetAppTypes', 'query', variables);
    },
    GetActionTypes(variables?: GetActionTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetActionTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetActionTypesQuery>(GetActionTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetActionTypes', 'query', variables);
    },
    GetCodeMirrorTypes(variables?: GetCodeMirrorTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetCodeMirrorTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetCodeMirrorTypesQuery>(GetCodeMirrorTypesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetCodeMirrorTypes', 'query', variables);
    },
    GetTypeOptions(variables?: GetTypeOptionsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetTypeOptionsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetTypeOptionsQuery>(GetTypeOptionsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetTypeOptions', 'query', variables);
    }
  };
}
