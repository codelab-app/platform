...
export type GetComponentsQuery = { aggregate: { count: number }, items: Array<ComponentFragment> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreateComponents(variables: CreateComponentsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateComponentsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateComponentsMutation>(CreateComponentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateComponents', 'mutation', variables);
    },
    DeleteComponents(variables?: DeleteComponentsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteComponentsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteComponentsMutation>(DeleteComponentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteComponents', 'mutation', variables);
    },
    UpdateComponents(variables?: UpdateComponentsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdateComponentsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateComponentsMutation>(UpdateComponentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateComponents', 'mutation', variables);
    },
    GetComponents(variables?: GetComponentsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetComponentsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetComponentsQuery>(GetComponentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetComponents', 'query', variables);
    }
  };
}
