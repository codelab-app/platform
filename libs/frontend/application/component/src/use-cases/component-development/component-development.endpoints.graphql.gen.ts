...
export type GetComponentDevelopmentQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetComponentDevelopmentQuery = { actionTypes: Array<ActionTypeFragment>, atoms: Array<AtomDevelopmentFragment>, codeMirrorTypes: Array<CodeMirrorTypeFragment>, components: Array<ComponentDevelopmentFragment>, primitiveTypes: Array<PrimitiveTypeFragment>, reactNodeTypes: Array<ReactNodeTypeFragment>, renderPropTypes: Array<RenderPropTypeFragment>, resources: Array<ResourceFragment>, richTextTypes: Array<RichTextTypeFragment> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetComponentDevelopment(variables?: GetComponentDevelopmentQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetComponentDevelopmentQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetComponentDevelopmentQuery>(GetComponentDevelopmentDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetComponentDevelopment', 'query', variables);
    }
  };
}
