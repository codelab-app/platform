...
export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../../../node_modules/.vite/libs/frontend/application/renderer',
  plugins: [
    react(),
  ...
  build: {
    ...
    lib: {
      ...
      entry: {
        ...
        'use-cases/root-renderer': 'src/use-cases/root-renderer/index.ts',
      },
      name: '@codelab/frontend-application-renderer',
