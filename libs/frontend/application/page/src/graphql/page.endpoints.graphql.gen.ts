...
import { PageFragment, PageDevelopmentFragment } from '../../../../abstract/domain/src/page/page.fragment.graphql.gen';
import { GraphQLClient, RequestOptions } from 'graphql-request';
import { gql } from 'graphql-tag';
import { PageFragmentDoc, PageDevelopmentFragmentDoc } from '../../../../abstract/domain/src/page/page.fragment.graphql.gen';
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreatePages(variables: CreatePagesMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreatePagesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreatePagesMutation>(CreatePagesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreatePages', 'mutation', variables);
    },
    DeletePages(variables?: DeletePagesMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeletePagesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeletePagesMutation>(DeletePagesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeletePages', 'mutation', variables);
    },
    UpdatePages(variables?: UpdatePagesMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdatePagesMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdatePagesMutation>(UpdatePagesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdatePages', 'mutation', variables);
    },
    ...
    GetRenderedPage(variables: GetRenderedPageQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetRenderedPageQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRenderedPageQuery>(GetRenderedPageDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetRenderedPage', 'query', variables);
    }
  };
}
