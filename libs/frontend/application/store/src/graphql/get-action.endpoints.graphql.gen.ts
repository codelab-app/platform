...
import { Action_ApiAction_Fragment, Action_CodeAction_Fragment } from '../../../../abstract/domain/src/action/fragments/action.fragment.graphql.gen';
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetActions(variables?: GetActionsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetActionsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetActionsQuery>(GetActionsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetActions', 'query', variables);
    }
  };
}
