...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    DeleteCodeActions(variables: DeleteCodeActionsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteCodeActionsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteCodeActionsMutation>(DeleteCodeActionsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteCodeActions', 'mutation', variables);
    },
    DeleteApiActions(variables: DeleteApiActionsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteApiActionsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteApiActionsMutation>(DeleteApiActionsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteApiActions', 'mutation', variables);
    }
  };
}
