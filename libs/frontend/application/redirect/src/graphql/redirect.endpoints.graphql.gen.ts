...
export function getSdk(
  ...
  return {
    ...
    ): Promise<CreateRedirectsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateRedirectsMutation>(
    ...
    DeleteRedirects(
      ...
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<DeleteRedirectsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteRedirectsMutation>(
    ...
    UpdateRedirects(
      ...
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<UpdateRedirectsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateRedirectsMutation>(
    ...
    GetRedirects(
      ...
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<GetRedirectsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetRedirectsQuery>(GetRedirectsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetRedirects',
