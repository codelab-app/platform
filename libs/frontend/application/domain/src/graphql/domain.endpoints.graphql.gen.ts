...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    CreateDomains(variables: CreateDomainsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateDomainsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateDomainsMutation>(CreateDomainsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateDomains', 'mutation', variables);
    },
    UpdateDomains(variables: UpdateDomainsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdateDomainsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateDomainsMutation>(UpdateDomainsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateDomains', 'mutation', variables);
    },
    DeleteDomains(variables: DeleteDomainsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteDomainsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteDomainsMutation>(DeleteDomainsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteDomains', 'mutation', variables);
    }
  };
}
