...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreateProps(variables: CreatePropsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreatePropsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreatePropsMutation>(CreatePropsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateProps', 'mutation', variables);
    },
    UpdateProps(variables?: UpdatePropsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdatePropsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdatePropsMutation>(UpdatePropsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateProps', 'mutation', variables);
    },
    DeleteProps(variables: DeletePropsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeletePropsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeletePropsMutation>(DeletePropsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteProps', 'mutation', variables);
    },
    GetProps(variables?: GetPropsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPropsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPropsQuery>(GetPropsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetProps', 'query', variables);
    }
  };
}
