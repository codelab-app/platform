      ...
      children: [
        {
          type: 'Text',
          nodeType: 'React',
          props: { value: { eval: true, value: 'return this.props.Sidebar' } },
        },
      ],
    },
          ...
          children: [
            {
              ...
              nodeType: 'React',
              props: {
                value: { eval: true, value: 'return this.props.Header' },
              },
            },
          ],
        },
              ...
              children: [
                {
                  ...
                  nodeType: 'React',
                  props: {
                    value: { eval: true, value: 'return this.props.Content' },
                  },
                },
              ],
            },
              ...
              children: [
                {
                  ...
                  nodeType: 'React',
                  props: {
                    value: { eval: true, value: 'return this.props.Footer' },
                  },
                },
              ],
            },
