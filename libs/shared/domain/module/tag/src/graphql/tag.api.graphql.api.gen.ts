...
export const getSdk = (client: GraphQLClient) => ({
  CreateTags: (variables: Types.CreateTagsMutationVariables) =>
    gqlRequest(client, CreateTagsDocument.toString(), variables),
  UpdateTags: (variables: Types.UpdateTagsMutationVariables) =>
    gqlRequest(client, UpdateTagsDocument.toString(), variables),
  DeleteTags: (variables: Types.DeleteTagsMutationVariables) =>
    gqlRequest(client, DeleteTagsDocument.toString(), variables),
  GetTags: (variables: Types.GetTagsQueryVariables) =>
