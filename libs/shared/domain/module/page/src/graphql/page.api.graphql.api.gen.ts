...
export const getSdk = (client: GraphQLClient) => ({
  CreatePages: (variables: Types.CreatePagesMutationVariables) =>
    gqlRequest(client, CreatePagesDocument.toString(), variables),
  DeletePages: (variables: Types.DeletePagesMutationVariables) =>
    gqlRequest(client, DeletePagesDocument.toString(), variables),
  UpdatePages: (variables: Types.UpdatePagesMutationVariables) =>
    gqlRequest(client, UpdatePagesDocument.toString(), variables),
  PageList: (variables: Types.PageListQueryVariables) =>
    gqlRequest(client, PageListDocument.toString(), variables),
  GetRenderedPage: (variables: Types.GetRenderedPageQueryVariables) =>
