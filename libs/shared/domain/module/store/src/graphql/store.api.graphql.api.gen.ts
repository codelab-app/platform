...
export const getSdk = (client: GraphQLClient) => ({
  CreateStores: (variables: Types.CreateStoresMutationVariables) =>
    gqlRequest(client, CreateStoresDocument.toString(), variables),
  DeleteStores: (variables: Types.DeleteStoresMutationVariables) =>
    gqlRequest(client, DeleteStoresDocument.toString(), variables),
  GetStores: (variables: Types.GetStoresQueryVariables) =>
    gqlRequest(client, GetStoresDocument.toString(), variables),
  UpdateStores: (variables: Types.UpdateStoresMutationVariables) =>
