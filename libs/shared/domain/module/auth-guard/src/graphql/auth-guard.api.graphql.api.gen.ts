...
export const getSdk = (client: GraphQLClient) => ({
  GetAuthGuards: (variables: Types.GetAuthGuardsQueryVariables) =>
    gqlRequest(client, GetAuthGuardsDocument.toString(), variables),
  CreateAuthGuards: (variables: Types.CreateAuthGuardsMutationVariables) =>
    gqlRequest(client, CreateAuthGuardsDocument.toString(), variables),
  UpdateAuthGuard: (variables: Types.UpdateAuthGuardMutationVariables) =>
    gqlRequest(client, UpdateAuthGuardDocument.toString(), variables),
  DeleteAuthGuards: (variables: Types.DeleteAuthGuardsMutationVariables) =>
