...
export const getSdk = (client: GraphQLClient) => ({
  CreateElements: (variables: Types.CreateElementsMutationVariables) =>
    gqlRequest(client, CreateElementsDocument.toString(), variables),
  DeleteElements: (variables: Types.DeleteElementsMutationVariables) =>
    gqlRequest(client, DeleteElementsDocument.toString(), variables),
  UpdateElements: (variables: Types.UpdateElementsMutationVariables) =>
    gqlRequest(client, UpdateElementsDocument.toString(), variables),
  ElementList: (variables: Types.ElementListQueryVariables) =>
