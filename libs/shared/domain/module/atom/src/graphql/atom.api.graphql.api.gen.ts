...
export const getSdk = (client: GraphQLClient) => ({
  CreateAtoms: (variables: Types.CreateAtomsMutationVariables) =>
    gqlRequest(client, CreateAtomsDocument.toString(), variables),
  DeleteAtoms: (variables: Types.DeleteAtomsMutationVariables) =>
    gqlRequest(client, DeleteAtomsDocument.toString(), variables),
  AtomList: (variables: Types.AtomListQueryVariables) =>
    gqlRequest(client, AtomListDocument.toString(), variables),
  UpdateAtoms: (variables: Types.UpdateAtomsMutationVariables) =>
