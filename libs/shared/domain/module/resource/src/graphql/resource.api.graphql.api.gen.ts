...
export const getSdk = (client: GraphQLClient) => ({
  ResourceList: (variables: Types.ResourceListQueryVariables) =>
    gqlRequest(client, ResourceListDocument.toString(), variables),
  CreateResources: (variables: Types.CreateResourcesMutationVariables) =>
    gqlRequest(client, CreateResourcesDocument.toString(), variables),
  UpdateResources: (variables: Types.UpdateResourcesMutationVariables) =>
    gqlRequest(client, UpdateResourcesDocument.toString(), variables),
  DeleteResources: (variables: Types.DeleteResourcesMutationVariables) =>
