...
export const UpdateArrayTypes = (
  variables: Types.UpdateArrayTypesMutationVariables,
  next?: NextFetchOptions,
) => gqlServerRequest(UpdateArrayTypesDocument.toString(), variables, next)
export const UpdateUnionTypes = (
  variables: Types.UpdateUnionTypesMutationVariables,
  next?: NextFetchOptions,
...
export const UpdateElementTypes = (
  variables: Types.UpdateElementTypesMutationVariables,
  next?: NextFetchOptions,
...
export const UpdateActionTypes = (
  variables: Types.UpdateActionTypesMutationVariables,
  next?: NextFetchOptions,
