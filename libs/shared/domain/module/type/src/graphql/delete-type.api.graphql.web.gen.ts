...
export const DeleteAnyTypes = (variables: Types.DeleteAnyTypesMutationVariables, next?: NextFetchOptions) => gqlServerRequest(DeleteAnyTypesDocument.toString(), variables, next)
