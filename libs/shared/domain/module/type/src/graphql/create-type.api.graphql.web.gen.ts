...
export const CreateAnyTypes = (variables: Types.CreateAnyTypesMutationVariables, next?: NextFetchOptions) => gqlServerRequest(CreateAnyTypesDocument.toString(), variables, next)
