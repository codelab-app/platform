...
export const CreateArrayTypes = (
  variables: Types.CreateArrayTypesMutationVariables,
  next?: NextFetchOptions,
) => gqlServerRequest(CreateArrayTypesDocument.toString(), variables, next)
export const CreateUnionTypes = (
  variables: Types.CreateUnionTypesMutationVariables,
  next?: NextFetchOptions,
...
export const CreateElementTypes = (
  variables: Types.CreateElementTypesMutationVariables,
  next?: NextFetchOptions,
...
export const CreateActionTypes = (
  variables: Types.CreateActionTypesMutationVariables,
  next?: NextFetchOptions,
