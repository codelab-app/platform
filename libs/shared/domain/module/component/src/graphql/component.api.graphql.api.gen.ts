...
export const getSdk = (client: GraphQLClient) => ({
  CreateComponents: (variables: Types.CreateComponentsMutationVariables) =>
    gqlRequest(client, CreateComponentsDocument.toString(), variables),
  DeleteComponents: (variables: Types.DeleteComponentsMutationVariables) =>
    gqlRequest(client, DeleteComponentsDocument.toString(), variables),
  UpdateComponents: (variables: Types.UpdateComponentsMutationVariables) =>
    gqlRequest(client, UpdateComponentsDocument.toString(), variables),
  ComponentList: (variables: Types.ComponentListQueryVariables) =>
