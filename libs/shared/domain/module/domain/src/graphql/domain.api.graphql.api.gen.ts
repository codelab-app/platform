...
export const getSdk = (client: GraphQLClient) => ({
  DomainList: (variables: Types.DomainListQueryVariables) =>
    gqlRequest(client, DomainListDocument.toString(), variables),
  CreateDomains: (variables: Types.CreateDomainsMutationVariables) =>
    gqlRequest(client, CreateDomainsDocument.toString(), variables),
  UpdateDomains: (variables: Types.UpdateDomainsMutationVariables) =>
    gqlRequest(client, UpdateDomainsDocument.toString(), variables),
  DeleteDomains: (variables: Types.DeleteDomainsMutationVariables) =>
