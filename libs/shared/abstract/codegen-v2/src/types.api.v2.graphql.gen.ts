...
export type AnyType = AppType | ArrayType | ElementType | EnumType | InterfaceType | LambdaType | MonacoType | PageType | PrimitiveType | RenderPropsType | UnionType;
 ...
 */
export type InterfaceTypeEdge = Field & IEdge & {
