...
import { DistributiveOmit } from '@codelab/shared/abstract/types'
...
// Uses OGM types
export type ITypeExport = DistributiveOmit<
  OGM_TYPES.PrimitiveType | OGM_TYPES.EnumType | OGM_TYPES.InterfaceType,
