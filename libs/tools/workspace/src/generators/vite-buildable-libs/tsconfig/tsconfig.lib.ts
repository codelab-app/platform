...
// Helper function to remove compilerOptions.module
const _removeCompilerOptionsModule = (tree: Tree, tsconfigPath: string) => {
  updateJson(tree, tsconfigPath, (json: TsConfigJson) => {
...
/**
 * Updates tsconfig.lib.json for Vite buildable libraries.
 * - Removes the compilerOptions.module property using the helper.
 * - Updates the 'extends' property using the _updateExtendsPath helper.
 */
export const updateTsConfigLib = (
  tree: Tree,
  projectConfig: ProjectConfiguration,
) => {
