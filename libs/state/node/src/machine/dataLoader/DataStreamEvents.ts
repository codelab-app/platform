...
export interface EventDataLoaderDataLoaded<TData, TId> extends EventObjectWithId<TId> {
...
export type DataStreamEvents<TData, TId extends string = "dataLoader"> = EventDataLoaderDataLoaded<TData, TId> | EventDataLoaderFailed<TId>
