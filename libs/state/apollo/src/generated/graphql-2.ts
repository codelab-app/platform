...
import { watchQuery, mutate } from '@codelab/alpha/shared/utils'
...
export type EdgeFragmentFragment = (
  { __typename?: 'edge' }
  & Pick<Edge, '[object Object]' | '[object Object]' | '[object Object]'>
);

export type GraphFragmentFragment = (
  { __typename?: 'graph' }
  & Pick<Graph, '[object Object]' | '[object Object]'>
);
...
export type VertexFragmentFragment = (
  { __typename?: 'vertex' }
  & Pick<Vertex, '[object Object]' | '[object Object]'>
);
...
export const graphsWatchQuery = (options: WatchQueryOptions<GraphsQueryVariables, GraphsQuery> = {}) => {
...
export const graphWatchQuery = (options: WatchQueryOptions<GraphQueryVariables, GraphQuery> = {}) => {
...
export const createGraphMutate = (options: MutationOptions<CreateGraphMutation, CreateGraphMutationVariables> = {}) => {
  return mutate<CreateGraphMutation, CreateGraphMutationVariables>(getApolloClient(), {
    query: CreateGraphDocument,
    context: {
      clientName: 'hasura',
    },
    ...options
...
export const verticesWatchQuery = (options: WatchQueryOptions<VerticesQueryVariables, VerticesQuery> = {}) => {
