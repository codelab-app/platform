...
export function getSdk(
  ...
  return {
    TestCreateDomainApps(
      variables: TestCreateDomainAppsMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<TestCreateDomainAppsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<TestCreateDomainAppsMutation>(
    ...
    TestCreateDomains(
      variables: TestCreateDomainsMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<TestCreateDomainsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<TestCreateDomainsMutation>(
    ...
    TestUpdateDomains(
      variables: TestUpdateDomainsMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<TestUpdateDomainsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<TestUpdateDomainsMutation>(
    ...
    TestDeleteDomains(
      variables: TestDeleteDomainsMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<TestDeleteDomainsMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<TestDeleteDomainsMutation>(
